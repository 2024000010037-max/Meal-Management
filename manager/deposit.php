 ...
 <script>
        $(document).ready(function() {
            ...
            function calculateTotal() {
                ...
                totalDisplay.textContent = (total > 0 ? '+' : '') + total.toFixed(2);
                totalDisplay.className = 'text-end fw-bold ' + (total < 0 ? 'text-danger' : 'text-success');
            }
            ...
            // Auto-open Add Tab if returning cash
            <?php if($pre_amount): ?>
                var addTab = new bootstrap.Tab(document.querySelector('#pills-add-tab'));
                addTab.show();
            <?php endif; ?>
        });
    </script>
